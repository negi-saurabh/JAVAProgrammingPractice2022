package com.saurabh.practice.randomalgoproblems;
...
public class GetLongestNumberFromString {
    ...
    private String getLongest(String input) {
        ...
        return listOfStrings.stream().sorted(Comparator.comparingInt(String::length)).collect(Collectors.toList()).get(0); // should get last
    }
